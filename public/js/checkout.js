...
StripeCheckout.require.define({
    "lib/optionSpecs": function (exports, require, module) {
        (function () {
            var BOOLEAN, BUTTON, BUTTON_CONFIGURE_OPTIONS, BUTTON_OPEN_OPTIONS, CUSTOM, CUSTOM_CONFIGURE_OPTIONS, CUSTOM_OPEN_OPTIONS, ERROR, EVENTUALLY_REQUIRED, NULLABLE_BOOLEAN, NULLABLE_NUMBER, NULLABLE_STRING, NULLABLE_URL, NUMBER, OPTIONAL, OPTIONS, OTHER, PRIVATE, REQUIRED, STRING, URL, WARNING, generateOptions, helpers, option, optionHelpers, optionValidator, optsettings, paymentMethods, ref, ref1;
            helpers = require("lib/helpers");
            optionHelpers = require("lib/optionHelpers");
            paymentMethods = require("lib/paymentMethods");
            optionValidator = require("lib/optionValidator");
            ref = optionValidator.severities, ERROR = ref.ERROR, WARNING = ref.WARNING;
            ref1 = optionValidator.importances, OPTIONAL = ref1.OPTIONAL, REQUIRED = ref1.REQUIRED, EVENTUALLY_REQUIRED = ref1.EVENTUALLY_REQUIRED, PRIVATE = ref1.PRIVATE;
            BUTTON = "button";
            CUSTOM = "custom";
            STRING = "string";
            URL = "url";
            ...
            checkUnrecognizedOptions = function (OPTIONS, arg, rawOptions) {
                ...
                for (option in rawOptions) {
                    if (!(option in OPTIONS.all)) {
                        ...
                        if (indexOf.call(OPTIONS.required, suggestion) >= 0) {
...
StripeCheckout.require.define({
    "lib/tracker": function (exports, require, module) {
        (function () {
            var base64, config, helpers, isEventNameExisting, mixpanel, pixel, stateParameters, trace, traceSerialize, track, tracker, uuid, indexOf = [].indexOf || function (item) {
                for (var i = 0, l = this.length; i < l; i++) {
                    if (i in this && this[i] === item) return i
                }
                return -1
...
/*--------------*/  console.log(mergedOptions)
                ...
                App.prototype.validateOptions = function (options, which) {
                    var error, url;
                    // document.getElementsByClassName(".Header--noLogo")[0].style.backgroundColor = "#000620";
                    try {
                ...
                App.prototype.trackOpen = function (checkout, options) {
                    ...
                    if (checkout.ab_fullscreen_mobile_iframe) {
                        data.ab_fullscreen_mobile_iframe = checkout.ab_fullscreen_mobile_iframe
                    }
        ...
        (function () {
            ...
            Checkout = function () {
                ...
                function Checkout(tokenCallback, options, configOptions) {
                    ...
                    var USE_SFSCV_FALLBACK_LIKELIHOOD, couldBeBrokenSFSVC, forceIframeViewFromQuery, isFullscreenMobileCapableViewport;
                    ...
                    USE_SFSCV_FALLBACK_LIKELIHOOD = 1;
                    ...
                    this.useFullscreenMobileView = forceIframeViewFromQuery || couldBeBrokenSFSVC && isFullscreenMobileCapableViewport && Math.random() < USE_SFSCV_FALLBACK_LIKELIHOOD;
                    if (couldBeBrokenSFSVC && isFullscreenMobileCapableViewport) {
                        this.ab_fullscreen_mobile_iframe = this.useFullscreenMobileView ? "on" : "control"
                    }
                ...
                Checkout.prototype.createView = function (useManhattan) {
                    ...
                    path = function () {
                        switch (false) {
                            case viewClass !== FallbackView:
                                return "/v3/fallback/FnJzj8ki6HYInSwWJrRIDw.html";
                            case !useManhattan:
                                return "/m/v3/index-6da11f252ec7f2954d8b82138b5a7a14.html";
                            default:
                                return "/v3/ENo08B7mC7MRAoNoFKW0KQ.html"
                        }
                    }();
                    ...
                    if (this.ab_fullscreen_mobile_iframe) {
                        path = path + "&ab_fullscreen_mobile_iframe=" + this.ab_fullscreen_mobile_iframe
                    }
                ...
                Checkout.prototype.open = function (options) {
                    ...
                    cb = function (_this) {
                        return function () {
                            ...
                            if (_this.ab_fullscreen_mobile_iframe) {
                                options.ab_fullscreen_mobile_iframe = _this.ab_fullscreen_mobile_iframe
                            }
                            ...
                            iframeFallback = function () {
                                ...
                                _this.view = new IframeView(_this.onToken, _this.host, "/v3/ENo08B7mC7MRAoNoFKW0KQ.html");
